            ...
            <div class="card-body">
                ...
                <div class="form-group" data-select2-id="29">
                    ...
                    <select name="author_id" id="author_id" class="form-control select2 select2-hidden-accessible"
                        ...
                        <option selected value="" data-select2-id="3"> Select an Author </option>
                        @foreach ($authors as $author)
                            <option value="{{ $author->id }}" data-select2-id="3">{{ $author->user->first_name ." ". $author->user->last_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group" data-select2-id="29">
