        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @canAny('Index Authors', 'Create Author', 'Index Admins', 'Create Admin')

                            <li class="nav-header">User mangement</li>
                        @endcan
                        @canAny('Index Admins', 'Create Admin')
                        ...
                        @endcan
                        @canAny('Index Authors', 'Create Author')
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                        ...
                        @auth('admin')
                            @canAny('Index setting', 'create setting')
                            ...
                            @canAny('index countries', 'create country')
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                            ...
                            @endcan
                            @canAny('index cities', 'create city')
                            ...
                            @endcan
                            @canAny('index categories', 'create category')
                            ...
                            @endcan
                            @canAny('index projects', 'create project')
                            ...
                            @canAny('index sliders', 'create slider')
                        ...
                        @endauth
                        @canAny('index articles', 'create article')
                        ...
                        @auth('admin')
                            ...
                            @endcan
                            @canAny('index features', 'create feature')
                            ...
                            @endcan
                            @canAny('index services', 'create service')
                            ...
                            @endcan
                            @canAny('index testimonials', 'create testimonial')
                            ...
                            @endcan
                            @canAny('index workers', 'create worker')
                            ...
                            @can('index subscripers')
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview" style="display: none;">
                                        <li class="nav-item">
                                            <a href="{{ route('subscripers.index') }}" class="nav-link">
                                                <i class="fa fa-list nav-icon"></i>
                                                <p>index</p>
                                            </a>
                                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('ProfileEdit') }}" class="nav-link">
                                <i class="fa fa-user nav-icon"></i>
                                <p>Edit Your profile</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('PasswordEdit') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('cms.logout') }}" class="nav-link">
                                <i class="nav-icon fas fa-arrow-right fa-sign-out"></i>
                                <p>logout</p>
                            </a>
                        </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Dashboard | @yield('title')</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
