                            ...
                            <div class="row gx-4 align-items-center">
                                <div class="col-xl-4 col-lg-5 col-md-5">
                                    <img class="img-fluid w-100 h-100 bg-light p-lg-3 mb-4 mb-md-0"
                                       src="{{ asset('storage/images/testimonial/' . $testimonial->image) }}" alt="">
                                </div>
                                <div class="col-xl-8 col-lg-7 col-md-7">
                                    <h4 class="text-uppercase mb-0">{{ $testimonial->client_name }}</h4>
                                    <p>{{ $testimonial->client_position }}</p>
                                    <p class="fs-5 mb-0"><i class="fa fa-2x fa-quote-left text-primary me-2"></i> {{ $testimonial->client_testimonial }}</p>
                                </div>
                            </div>
                        @endforeach
